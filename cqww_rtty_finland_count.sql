...
dxcall,count(*) as kountti
  --id, sig_noise, datetime, insert_time, mode, de_continent, dx_continent, info, de_country, spotter_continent, skimmode
    ...
    WHERE a.insert_time >= to_timestamp('2018-09-29 00:00'::text, 'yyyy-mm-dd hh24:mi'::text) 
    AND a.insert_time < to_timestamp('2018-09-30 23:59'::text, 'yyyy-mm-dd hh24:mi'::text)
