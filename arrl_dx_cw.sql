SELECT title, decall, dxcall, freq, band, country, id, sig_noise, datetime, insert_time, mode, de_continent, dx_continent, info, de_country, spotter_continent, skimmode
    ...
    WHERE a.insert_time >= to_timestamp('2017-02-18 00:00'::text, 'yyyy-mm-dd hh24:mi'::text) 
    AND a.insert_time < to_timestamp('2017-02-20 00:00'::text, 'yyyy-mm-dd hh24:mi'::text)
    ...
    '15M'::character varying::text, '10M'::character varying::text, '160M'::character varying::text]))
